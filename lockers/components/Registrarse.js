...
import { Text, TextInput, TouchableOpacity,Pressable, ScrollView, StyleSheet, View } from "react-native";
...
export default function Registrarse({ navigation }){
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post(`http://${IP_ADDRESS}:9000/registrarUsuario`, {
        nombre: data.txtName,
        apPat: data.txtapPat,
        apMat: data.txtapMat,
  ...
  return (
    ...
    <View style={styles.formContainer}>
      ...
      <View>
        ...
        <Text style={styles.radioLabel}>Departamentos:</Text>
